...
public class PopularMovieProvider extends ContentProvider {
    ...
    static final int MOVIES = 50;

    private static UriMatcher buildUriMatcher() {
        final UriMatcher matcher = new UriMatcher(UriMatcher.NO_MATCH);
        final String authority = PopularMovieContract.CONTENT_AUTHORITY;
        matcher.addURI(authority, PopularMovieContract.PATH_MOVIE, MOVIES);
        return matcher;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case MOVIES: {
                long id = db.insert(PopularMovieContract.PopularMovieEntry.TABLE_NAME, null, values);
                if (id > 0) {
                    returnUri = PopularMovieContract.PopularMovieEntry.buildMovieUri(id);
                } else {
